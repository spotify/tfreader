...
object Dependencies {
  lazy val protobufVersion = "3.12.0"
  lazy val protobuf = "com.google.protobuf" % "protobuf-java-util" % protobufVersion
  ...
  lazy val caseApp = "com.github.alexarchambault" %% "case-app" % "2.0.0-M16"
